...
class Subscription(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        # Do not clear stripe_id after saving; it must remain set for related price creation and future use.
...
class SubscriptionPrice(models.Model):
    ...
    def product_stripe_id(self):
        if not self.subscription or not getattr(self.subscription, "stripe_id", None):
            return None
...
def user_sub_post_save(sender, instance, *args, **kwargs):
    ...
    if not ALLOW_CUSTOM_GROUPS:
        ...
        if subscription_obj is not None:
            sub_qs = subs_qs.exclude(id=subscription_obj.id)
